    ...
    <div className="max-w-screen-xl mx-auto flex justify-between items-center px-4 sm:px-6 py-4">
      ...
      >
        <li className="text-center md:text-left">
          <a href="#home" className="block py-2 px-4 text-gray-900 hover:text-blue-500">
            Home
          </a>
        </li>
        <li className="text-center md:text-left">
          <a href="#about" className="block py-2 px-4 text-gray-900 hover:text-blue-500">
            Sobre
          </a>
        </li>
        <li className="text-center md:text-left">
          <a href="#projects" className="block py-2 px-4 text-gray-900 hover:text-blue-500">
            Projetos
          </a>
        </li>
      </ul>
